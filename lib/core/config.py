...
config.DATASET.VALID_DATASET = 'multi_view_h36m'
config.DATASET.TEST_DATASET = 'multi_view_h36m'
config.DATASET.TEST_OCC_DATASET = 'multi_view_h36m'
config.DATASET.TRAIN_SUBSET = 'train'
config.DATASET.VALID_SUBSET = 'validation'
config.DATASET.TEST_SUBSET = 'test'
config.DATASET.TEST_OCC_SUBSET = 'test_occ'
...
config.DATASET.AUG_TYPE = 'original'
config.DATASET.CAM_SIMILARITY = 20
config.DATASET.DATA_NUM = 100
config.DATASET.AUG_RATIO = 0
config.DATASET.HEATMAP_GENERATION = 'target'
