...
class CampusSynthetic(Dataset):
    def __init__(self, cfg, image_set, is_train, transform=None):
        ...
        # self.db_file = osp.join(dataset_root, 'pkl_file/original', f"cam{self.num_views}_{self.data_num}.pkl")
        self.db_file = f'original_{self.image_set}_data{self.data_num:03d}.pkl'
    ...
    def __getitem__(self, idx):
        ...
        # # random으로 sampling 된 nposes명의 pose를 random으로 선택
        ...
        #     center = (points[11, :2] + points[12, :2]) / 2   # mid hip 부분
