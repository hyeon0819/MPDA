...
class ProposalLayer(nn.Module):     # root_cubes로부터 사람이 있을만한 grid_center를 반환 (people presence likelihood)
    ...
    def get_real_loc(self, index):   # 80*80*20 위치에서 8000*8000*2000 위치로 변환
        device = index.device
